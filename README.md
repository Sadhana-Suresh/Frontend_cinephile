...
Cinephile is an interactive, front-end web application where users can search, discover, rate, and review movies. Built using HTML, CSS, JavaScript, and the OMDB API, Cinephile provides a clean and engaging way to explore films and share opinions — making it a hub for movie enthusiasts.

🌟 Features 🔍 Movie Search — Instantly search for movies using the OMDB API.
...
Technology Purpose HTML5 Structure and layout CSS3 Styling and responsive design JavaScript (ES6) Interactivity and DOM manipulation OMDB API Fetching real-time movie data
...
Sadhana 📧 College Student | CSE 💭 “Building creative, real-world projects one line of code at a time.”
